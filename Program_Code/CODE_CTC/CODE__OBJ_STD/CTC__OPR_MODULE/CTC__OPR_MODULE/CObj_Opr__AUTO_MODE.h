...
private:
	...
	CX__VAR_DIGITAL_CTRL dEXT_CH__CFG_DB_STx_LOTID_CHECK;
	...
	int  Check__LLx_ALL_MODE_ERROR(CII_OBJECT__ALARM *p_alarm);
	int  _Check__LLx_ALL_MODE_ERROR(CII_OBJECT__ALARM *p_alarm, bool& active__ll_all_in_out);
	int  Get__LLx_ALL_MODE_STATE(bool& active__ll_all_in_out);
