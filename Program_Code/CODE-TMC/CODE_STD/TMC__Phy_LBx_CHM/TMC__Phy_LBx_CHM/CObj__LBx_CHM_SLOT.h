...
private:
	...
	CX__VAR_DIGITAL_CTRL dEXT_CH__CFG_SETUP_PRESSURE_CHECK;
	...
	bool bActive_DO__LLx_SV_UP_X[CFG_LBx__SLOT_SIZE];
	CX__VAR_DIGITAL_CTRL doEXT_CH__LLx_SV_UP_X[CFG_LBx__SLOT_SIZE];
	bool bActive_DO__LLx_SV_DOWN_X[CFG_LBx__SLOT_SIZE];
	CX__VAR_DIGITAL_CTRL doEXT_CH__LLx_SV_DOWN_X[CFG_LBx__SLOT_SIZE];

	bool bActive_DI__LLx_SV_UP_X[CFG_LBx__SLOT_SIZE];
	CX__VAR_DIGITAL_CTRL diEXT_CH__LLx_SV_UP_X[CFG_LBx__SLOT_SIZE];
	bool bActive_DI__LLx_SV_DOWN_X[CFG_LBx__SLOT_SIZE];
	CX__VAR_DIGITAL_CTRL diEXT_CH__LLx_SV_DOWN_X[CFG_LBx__SLOT_SIZE];
	...
	CX__VAR_DIGITAL_CTRL diEXT_CH__LLx_ATM_SNS;
	CX__VAR_DIGITAL_CTRL diEXT_CH__LLx_VAC_SNS;
	...
	bool Is__SLOT_SV_OPEN(const int lp_index, const bool active__down_check = true);
	bool Is__SLOT_SV_CLOSE();
	bool Is__SLOT_SV_CLOSE(const int lp_index, const bool active__down_check = true);

	bool Is__SLOT_SV_UP();
	bool Is__SLOT_SV_UP(const int lp_index);
	bool Is__SLOT_SV_DOWN();
	bool Is__SLOT_SV_DOWN(const int lp_index);

	int  Set_IO__SV_OPEN(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm, const double cfg_timeout);
	int  End_IO__SV_OPEN();

	int  Set_IO__SV_CLOSE(CII_OBJECT__VARIABLE* p_variable, CII_OBJECT__ALARM* p_alarm, const double cfg_timeout);
