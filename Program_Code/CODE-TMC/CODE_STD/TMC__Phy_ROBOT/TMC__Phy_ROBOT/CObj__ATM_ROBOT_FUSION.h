...
private:
	...
	CX__VAR_DIGITAL_CTRL dCH__MON_ACTIVE_WAIT_BY_LPx[CFG_LPx__SIZE];
	...
	CX__VAR_STRING_CTRL  sCH__TAS_ACTION_TIME_NOW__ST2[CFG_ACT__SIZE];
	CX__VAR_STRING_CTRL  sCH__TAS_ACTION_TIME_MIN__ST2[CFG_ACT__SIZE];
	CX__VAR_STRING_CTRL  sCH__TAS_ACTION_TIME_MAX__ST2[CFG_ACT__SIZE];
	CX__VAR_STRING_CTRL  sCH__TAS_ACTION_TIME_AVG__ST2[CFG_ACT__SIZE];
	CX__VAR_STRING_CTRL  sCH__TAS_ACTION_TIME_AVG_F__ST2[CFG_ACT__SIZE];
	CX__VAR_ANALOG_CTRL  aCH__TAS_ACTION_TIME_CNT__ST2[CFG_ACT__SIZE];
	//
	...
	bool bActive__ROBOT_LPx_MAP_USE;
	...
	int  Fnc__LP_MAP(CII_OBJECT__VARIABLE* p_variable,
			 		 CII_OBJECT__ALARM* p_alarm,
					 const CString& arm_type,
					 const CString& stn_name,
					 const CString& stn_slot);

	int  Update__LP_MAP_INFO(CII_OBJECT__VARIABLE* p_variable,
						     CII_OBJECT__ALARM* p_alarm,
						     const CString& stn_name);
	...
	int  Call__TIME_TEST(CII_OBJECT__VARIABLE* p_variable,
						 CII_OBJECT__ALARM* p_alarm);

	// ...
	int  Check__STN_EXIST(CII_OBJECT__ALARM* p_alarm, 
						  const CString& stn_name,
						  const CString& stn_slot);
	//
