...
public:
	...
	// ...
	int Get__StringArrray_From_String(const CString& str_data,const CString& str_sep,CStringArray& l_data, const bool active__empty_count = false);
