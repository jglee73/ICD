...
//-------------------------------------------------------------------------
CObj__DELTA_II_IO::CObj__DELTA_II_IO()
{
...
//-------------------------------------------------------------------------
int CObj__DELTA_II_IO::__DEFINE__CONTROL_MODE(obj,l_mode)
{
	sObject_Name = obj;
	...
	// ...
	{
		...
		ADD__CTRL_VAR(sMODE__CH1_SET_RATIO,	"CH1.SET_RATIO");
		...
		ADD__CTRL_VAR(sMDDE__GASLINE_PUMP,  "GASLINE_PUMP");
	}
	return 1;
}
int CObj__DELTA_II_IO::__DEFINE__VERSION_HISTORY(version)
{
...
int CObj__DELTA_II_IO::__DEFINE__VARIABLE_STD(p_variable)
{
	...
	// ...
	{
		str_name = "CFG.CH2.SET_RATIO";
		STD__ADD_ANALOG_WITH_X_OPTION(str_name, "ratio", 0, 1.0, 9.0, "");
		LINK__VAR_ANALOG_CTRL(aCH__CFG_CH2_SET_RATIO, str_name);
	}

	// ...
	{
		str_name = "PARA.CH1.SET_RATIO";
		STD__ADD_ANALOG_WITH_OPTION(str_name, "ratio", 0, 1.0, 9.0, 1, "L", "");
		LINK__VAR_ANALOG_CTRL(aCH__PARA_CH1_SET_RATIO, str_name);

		str_name = "PARA.CH2.SET_RATIO";
		STD__ADD_ANALOG_WITH_OPTION(str_name, "ratio", 0, 1.0, 9.0, 1, "L", "");
		LINK__VAR_ANALOG_CTRL(aCH__PARA_CH2_SET_RATIO, str_name);
	}
	...
	// ...
	{
		...
		str_name = "MON.SW.RATIO";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_SW_RATIO, str_name);

		str_name = "MON.CH1.GET_RATIO";
		STD__ADD_STRING_WITH_OPTION(str_name, -1, "L", "");
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_GET_RATIO, str_name);

		str_name = "MON.CH2.GET_RATIO";
		STD__ADD_STRING_WITH_OPTION(str_name, -1, "L", "");
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_GET_RATIO, str_name);
	}
	...
	// Stable Channel ...
	{
		...
		//
		str_name = "MON.CH1.STABLE.STATE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_STABLE_STATE, str_name);

		str_name = "MON.CH1.STABLE.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_STABLE_TIME, str_name);

		str_name = "MON.CH1.FAULT.STATE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_FAULT_STATE, str_name);

		str_name = "MON.CH1.FAULT.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_FAULT_TIME, str_name);

		str_name = "MON.CH1.CHANGE.STATE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_CHANGE_STATE, str_name);

		str_name = "MON.CH1.CHANGE.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH1_CHANGE_TIME, str_name);

		//
		str_name = "MON.CH2.STABLE.STATE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_STABLE_STATE, str_name);

		str_name = "MON.CH2.STABLE.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_STABLE_TIME, str_name);

		str_name = "MON.CH2.FAULT.STATE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_FAULT_STATE, str_name);

		str_name = "MON.CH2.FAULT.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_FAULT_TIME, str_name);

		str_name = "MON.CH2.CHANGE.STATE";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_CHANGE_STATE, str_name);

		str_name = "MON.CH2.CHANGE.TIME";
		STD__ADD_STRING(str_name);
		LINK__VAR_STRING_CTRL(sCH__MON_CH2_CHANGE_TIME, str_name);
...
int CObj__DELTA_II_IO::__DEFINE__ALARM(p_alarm)
{
	DECLARE__ALARM;
...
//-------------------------------------------------------------------------
int CObj__DELTA_II_IO::__INITIALIZE__OBJECT(p_variable,p_ext_obj_create)
{	
	// ...
	{
		CString file_name;
...
//-------------------------------------------------------------------------
int CObj__DELTA_II_IO::__CALL__CONTROL_MODE(mode,p_debug,p_variable,p_alarm)
{
	int flag = -1;
	...
	// ...
	{
		...
		ELSE_IF__CTRL_MODE(sMODE__CH1_SET_RATIO)	flag = Call__CH1_SET_RATIO(p_variable, p_alarm);
		...
		ELSE_IF__CTRL_MODE(sMDDE__GASLINE_PUMP)		flag = Call__GASLINE_PUMP(p_variable,p_alarm);
...
int CObj__DELTA_II_IO::__CALL__MONITORING(id,p_variable,p_alarm)
{
